...
## Способы входа пользователей

Показывает распределение типов авторизации, которые используют пользователи.

## Количество созданных отзывов

Показывает сколько отзывов было создано пользователями за каждый день.

> Для него используется HIVE (для остальных - Clickhouse)